...
export default function TicketDetailModal({
  ...
  const getStatusColor = () => {
    if (isClosed) return 'bg-green-100 text-green-700';
    if (isAssigned) return 'bg-amber-100 text-amber-700';
    if (isOnProgress) return 'bg-blue-100 text-blue-700';
