        ...
        <div className='flex flex-col'>
          ...
          <div className='flex items-start justify-between border-b border-slate-100 py-2'>
            <div className='min-w-0 flex-1 pr-3'>
              <p className='mb-0.5 text-[10px] font-bold tracking-wide text-slate-400 uppercase'>
                Pelanggan
              </p>
            ...
            <div className='min-w-0 text-right'>
              ...
              {ticket.contactPhone ? (
                <a
                  ...
                  className='inline-flex items-center gap-1 truncate max-w-[140px] text-xs font-semibold text-emerald-600 hover:text-emerald-700 sm:text-sm'
                >
                  <svg
