...
export const TICKET_RAW_FIELDS: TicketRawField[] = [
  ...
  { key: 'ttr_customer', label: 'TTR Customer', required: false, type: 'string' },
  ...
  { key: 'reported_priority', label: 'Reported Priority', required: false, type: 'string' },
  { key: 'booking_date', label: 'Booking Date', required: false, type: 'string' },
  { key: 'description_assignment', label: 'Description Assignment', required: false, type: 'string' },
  { key: 'source_ticket', label: 'Source Ticket', required: false, type: 'string' },
  { key: 'subsidiary', label: 'Subsidiary', required: false, type: 'string' },
  { key: 'external_ticket_id', label: 'External Ticket ID', required: false, type: 'string' },
  ...
  { key: 'closed_reopen_by', label: 'Closed / Reopen By', required: false, type: 'string' },
  ...
  { key: 'date_modified', label: 'Date Modified', required: false, type: 'string' },
  { key: 'incident_domain', label: 'Incident Domain', required: false, type: 'string' },
  { key: 'region', label: 'Region', required: false, type: 'string' },
  { key: 'hierarchy_path', label: 'Hierarchy Path', required: false, type: 'string' },
  { key: 'description_actual_solution', label: 'Description Actual Solution', required: false, type: 'string' },
  ...
  { key: 'last_update_worklog', label: 'Last Update Worklog', required: false, type: 'string' },
  { key: 'classification_flag', label: 'Classification Flag', required: false, type: 'string' },
  { key: 'realm', label: 'Realm', required: false, type: 'string' },
  { key: 'related_to_gamas', label: 'Related To Gamas', required: false, type: 'string' },
  ...
  { key: 'ttr_nasional', label: 'TTR Nasional', required: false, type: 'string' },
  ...
  { key: 'ttr_end_to_end', label: 'TTR End To End', required: false, type: 'string' },
  { key: 'note', label: 'Note', required: false, type: 'string' },
  { key: 'guarantee_status', label: 'Guarantee Status', required: false, type: 'string' },
  { key: 'resolve_date', label: 'Resolve Date', required: false, type: 'string' },
  { key: 'sn_ont', label: 'SN ONT', required: false, type: 'string' },
  { key: 'tipe_ont', label: 'Tipe ONT', required: false, type: 'string' },
  { key: 'manufacture_ont', label: 'Manufacture ONT', required: false, type: 'string' },
  { key: 'impacted_site', label: 'Impacted Site', required: false, type: 'string' },
  ...
  { key: 'notes_eskalasi', label: 'Notes Eskalasi', required: false, type: 'string' },
  { key: 'rk_information', label: 'RK Information', required: false, type: 'string' },
  { key: 'external_ticket_tier_3', label: 'External Ticket Tier 3', required: false, type: 'string' },
  { key: 'customer_category', label: 'Customer Category', required: false, type: 'string' },
  { key: 'classification_path', label: 'Classification Path', required: false, type: 'string' },
  { key: 'teritory_near_end', label: 'Teritory Near End', required: false, type: 'string' },
  { key: 'teritory_far_end', label: 'Teritory Far End', required: false, type: 'string' },
  { key: 'urgency', label: 'Urgency', required: false, type: 'string' },
  { key: 'urgency_description', label: 'Urgency Description', required: false, type: 'string' },
...
export const FIELD_CANDIDATES: Record<string, string[]> = {
  ...
  owner: ['OWNER'],
  technician: ['TECHNICIAN', 'TEKNISI', 'ASSIGNEE', 'ASSIGNED TO', 'NAMA TEKNISI'],
  ...
  guarantee_status: ['GUARANTE STATUS', 'GUARANTEE STATUS', 'GUARANTEE_STATUS', 'GUARANTEE', 'GARANSI', 'FLAGGING', 'FFG'],
