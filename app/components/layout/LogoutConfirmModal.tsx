  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        {/* Text */}
        <h3 className='text-text-primary text-[17px] leading-snug font-semibold'>
          {title}
        </h3>
        ...
        <div className='mt-6 flex gap-2.5'>
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className='bg-error-500 hover:bg-error-600 flex h-12.5 flex-1 items-center justify-center gap-2 rounded-2xl text-[13.5px] font-semibold text-white shadow-[0_4px_14px_rgba(240,68,56,0.30)] transition-all active:scale-[0.97] disabled:opacity-60 disabled:shadow-none'
          >
            {loading && (
