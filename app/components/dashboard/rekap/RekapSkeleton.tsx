        ...
        <div className="space-y-4 p-4">
          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1.65fr)_minmax(280px,0.95fr)]">
            <div className="space-y-3">
              <div className="h-[360px] rounded-[28px] border border-(--border) bg-(--surface-2)" />
              <div className="grid grid-cols-2 gap-2 sm:grid-cols-4 xl:grid-cols-6">
                {Array.from({ length: 24 }).map((_, i) => (
                  <div key={i} className="rounded-2xl border border-(--border) bg-(--surface-2) p-2">
            ...
            <div className="space-y-3">
              <div className="h-[260px] rounded-[28px] border border-(--border) bg-(--surface-2)" />
              <div className="h-[150px] rounded-[28px] border border-(--border) bg-(--surface-2)" />
            </div>
          </div>
        </div>
      </div>
