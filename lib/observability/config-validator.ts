...
const SHARED_CONFIG: EnvVarSpec[] = [
  ...
  { name: 'JWT_ACCESS_EXPIRY', type: 'string', optional: true },
  { name: 'JWT_REFRESH_EXPIRY_SHORT', type: 'string', optional: true },
  { name: 'JWT_REFRESH_EXPIRY_LONG', type: 'string', optional: true },
